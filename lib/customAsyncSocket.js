...
function createCustomAsyncSocket(param1, param2){
     ...
     * requests. 
     * @param {object} options AsynSocket options to apply.
     * 
     * @returns {CustomAsyncSocket}
     */
    function CustomAsyncSocket(serverSocket, options){
        if(!(this instanceof CustomAsyncSocket)){
            return new CustomAsyncSocket(serverSocket, options);
        }
        
        var api = serverSocket ? new API(serverSocket) : void 0;
        AsyncSocket.call(this, api, options);
    }
    ...
    CustomAsyncSocket.prototype.addSocket = function(socket){
        ...
        var api = socket instanceof SocketApi ? socket : new API(socket);
        base.call(this, api);
    };
    
    /**
     * Returns the constructor of the socket api used by this instance.
     * 
     * @returns {function}
     */
    CustomAsyncSocket.prototype.getApiCtor = function(){
        return API;
    };
     ...
     * @returns {function}
     */
    CustomAsyncSocket.getApiCtor = function(){
        return API;
    };
